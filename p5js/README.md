...
The Hat is the H-supertile after two rounds of the H/T/P/F substitution in Smith, Myers, Kaplan and Goodman-Strauss's *An aperiodic monotile*. Its 169 Hat polygons are computed from the paper's exact polykite outline and substitution geometry rather than placed as a decorative approximation. Twenty-two have reversed orientation and are drawn in ochre; they are mirror copies of the same thirteen-vertex polygon, not a second prototile. The other colours preserve the H, T, P and F cluster labels at the base of the hierarchy. The circles behind the patch are deliberately regular, so the absence of any translational repetition in the masonry is seen against something that does repeat.
