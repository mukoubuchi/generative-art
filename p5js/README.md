...
Mystic Hexagram follows the letters and incidences of Pascal's 1640 placard rather than replacing them with a modern diagram. The six points run K-P-Q-V-O-N on one ellipse. Opposite sides KP and VO meet at M; PQ and ON meet at T; QV and NK meet at S. Their faint extensions are paired by colour, the six actual sides make the gold hexagram, and the pale line through M and S also passes through T. All six points make one circuit in ten seconds, with a smaller periodic displacement that keeps them apart, so the theorem has to keep finding its line rather than holding one convenient configuration still.
