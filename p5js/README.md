...
Two more things follow from the lean, and the canvas is one of them. A ring leaned back is half again as wide as it is tall, so on a square canvas its two ends had nowhere to go and ran off the sides, as they had in the original. The canvas is 800 by 600 now and nothing is cropped. The other is crowding: the nearest disc and the furthest sit at opposite ends of the ring, and whether they meet is a single comparison, because perspective magnifies how far apart they are and how large they are in the same proportion and it cancels. A disc has to be wider than the ring's own half-height — wider than the ring times the sine of the lean — and at forty-eight degrees it was not, by four pixels, which is why the two ends of the figure had come apart. The ring draws in to 160 and the discs grow to 272 across, which clears it by seventeen and puts the four of them back into one cluster.
