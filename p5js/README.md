...
The Hat is the H-supertile after two rounds of the H/T/P/F substitution in Smith, Myers, Kaplan and Goodman-Strauss's *An aperiodic monotile*. Its 169 Hat polygons are computed from the paper's exact polykite outline and substitution geometry rather than placed as a decorative approximation. One current of light crosses a single ember-to-sand stone family, while slight value steps preserve the H, T, P and F cluster labels at the base of the hierarchy. Twenty-two have reversed orientation and carry a pearl inner seam; they are mirror copies of the same thirteen-vertex polygon, not a second prototile. Fine clay seams hold the masonry together, and the deep ground recedes without a second geometry competing behind it.
