...
| [The Same Tower](p5js/artworks/the-same-tower/) | Sextus's tower in black single lines on warm white: a one-second pause in the round view before the approach to the square view, then a third eye revealing the bent floors on their shared footprint, rendered as an MP4 |
